...
TEST(List, Constructor_Initializer_List) {
  s21::list<int> customList = {1, 2, 3, 4, 5};
...
TEST(List, Constructor_Copy) {
  ...
  s21::list<int> customListCopy(originalList);
  std::list<int> stdList = {1, 2, 3, 4, 5};
...
TEST(List, Constructor_Move) {
  s21::list<int> originalList = {1, 2, 3, 4, 5};
  s21::list<int> customListMoved(std::move(originalList));
  std::list<int> stdList = {1, 2, 3, 4, 5};
...
TEST(List, Operator_Copy) {
  ...
  EXPECT_EQ(originalList.size(), stdList.size());
  EXPECT_EQ(customListCopy.size(), stdList.size());
  s21::list<int>::iterator customListIterator;
...
TEST(List, Front) {
  s21::list<int> customList = {5, 4, 3, 2, 1};
...
TEST(List, Swap) {
  s21::list<int> customList = {1, 2, 3, 4, 5};
  s21::list<int> customList1 = {5, 4, 3, 2, 1};
...
TEST(List, Sort) {
  s21::list<int> customList = {1, 2, 3, 4, 5, 2, 4, 2, 1};
...
TEST(List, Iterator) {
  s21::list<int> customList = {1234, 228, 123, 69};
  s21::list<int>::const_iterator customListIterator = customList.end();
  --customListIterator;
  ...
  customListIterator = customListIterator + 2;
  EXPECT_EQ(*customListIterator, 4);
  s21::list<int>::iterator customListIterator1 = customList.begin();
  --customListIterator1;
  EXPECT_EQ(*customListIterator, 4);
}

TEST(List, Insert) {
  s21::list<int> customList = {1, 2, 3, 4};
  ...
  s21::list<int> customList1;
  s21::list<int>::iterator customListIterator1;
  ...
  s21::list<int> customList2 = {1, 2, 3, 4, 5, 6};
  s21::list<int>::iterator customListIterator2 = customList2.end();
...
TEST(List, Erase) {
  s21::list<int> customList = {1, 2, 3, 4, 5, 6, 7};
  s21::list<int>::iterator customListIterator;
...
TEST(List, Splice) {
  s21::list<int> customList = {1};
  s21::list<int> customList1 = {2, 3, 4, 5};
  std::list<int> stdList = {1};
  std::list<int> stdList1 = {2, 3, 4, 5};
  s21::list<int>::iterator it = customList.begin();
...
TEST(List, Merge) {
  s21::list<int> customList = {1, 2, 3, 4};
  s21::list<int> customListToMerge = {2, 5, 4, 3};
  std::list<int> stdList = {1, 2, 3, 4};
